...
const features = [
  {
    number: "01",
    title: "Branding",
    description: "Identità di brand distintive emergono attraverso loghi strategici, linee guida visive coerenti e sistemi grafici pensati nei minimi dettagli. Ogni elemento è progettato con precisione per raccontare la tua storia e creare una connessione emotiva autentica.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Web Design",
    description: "Dalla UI pixel-perfect a interazioni 3D immersive, uniamo un’estetica di livello editoriale a esperienze utente intuitive. Prototipiamo, iteriamo e rifiniamo ogni interfaccia fino a renderla tanto fluida da utilizzare quanto d’impatto da guardare.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Development",
    description: "Diamo vita ai design attraverso framework moderni, JavaScript personalizzato e codice ad alte prestazioni. Il nostro processo di sviluppo garantisce che ogni animazione sia fluida, ogni interazione risulti naturale e ogni pagina si carichi in un istante. La base che costruiamo è tanto affidabile quanto curata dal punto di vista estetico.",
    visual: "collab",
  }
];
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Design, sviluppo e strategia
            <br />
            <span className="text-muted-foreground">in un unico sistema</span>
          </h2>
        </div>
